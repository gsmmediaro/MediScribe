...
export const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
    // ... cod svg ...
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 2a5.3 5.3 0 0 1 5.3 5.3c0 1.8-1.1 3.4-2.7 4.3"></path>
        <path d="M12 2a5.3 5.3 0 0 0-5.3 5.3c0 1.8 1.1 3.4 2.7 4.3"></path>
        <path d="M5 12.6A5.3 5.3 0 0 0 12 22a5.3 5.3 0 0 0 7-9.4"></path>
        <path d="M14.7 11.7a5.3 5.3 0 0 1-5.4 0"></path>
        <path d="M12 2v2.5"></path><path d="M19.4 6.6l-2.1 1.2"></path>
        <path d="M4.6 6.6l2.1 1.2"></path><path d="M12 22v-2.5"></path>
        <path d="M18 17.9l-2.1-1.2"></path><path d="M6 17.9l2.1-1.2"></path>
...
export const BadgeInfoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
